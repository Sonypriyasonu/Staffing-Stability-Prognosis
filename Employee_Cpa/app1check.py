...
# with open('C:/Users/Sony Priya/Desktop/Project/Employee_Cpa/STAFFING STABILITY  Predictor.ipynb') as f:
#     nb = nbformat.read(f, as_version=4)

# ep = ExecutePreprocessor(timeout=600, kernel_name='python3')


# ep.preprocess(nb, {'metadata': {'C:/Users/Sony Priya/Desktop/Project/Employee_Cpa/STAFFING STABILITY  Predictor.ipynb': 'notebooks/'}})
# with open('executed_notebook.ipynb', 'w', encoding='utf-8') as f:
#     nbformat.write(nb, f)

ALLOWED_EXTENSIONS = set(['csv'])

UPLOAD_FOLDER = 'C:/Users/Sony Priya/Desktop/Project/Employee_Cpa/static/input'
...
def process_file(save_location):
    ...
    lr_from_pickle = pickle.load(open('C:/Users/Sony Priya/Desktop/Project/Employee_Cpa/model.pkl', 'rb'))
    ...
    with open('Entire.csv', 'w') as file1,open('leave.csv','w') as file2,open('stay.csv','w') as file3:
        ...
        temp.to_csv('C:/Users/Sony Priya/Desktop/Project/Employee_Cpa/Data Sets/result.csv')
        with open('C:/Users/Sony Priya/Desktop/Project/Employee_Cpa/result_Analysis.ipynb') as f:
            nb = nbformat.read(f, as_version=4)

        ep = ExecutePreprocessor(timeout=600, kernel_name='python3')


        ep.preprocess(nb, {'metadata': {'C:/Users/Sony Priya/Desktop/Project/Employee_Cpa/result_analysis.ipynb': 'notebooks/'}})
...
def res():
    ...
    if request.method=='POST':
        num=request.form['ID']
        frame1=pd.read_csv("C:/Users/Sony Priya/Desktop/Project/leave.csv")
        frame2=pd.read_csv("C:/Users/Sony Priya/Desktop/Project/stay.csv")
...
def Download_file():
    path = "C:/Users/Sony Priya/Desktop/Project/Entire.csv"
    return send_file(path, as_attachment=True)

@app.route('/Download_file_leave', methods=['GET', 'POST'])
def Download_file_leave():
    path = "C:/Users/Sony Priya/Desktop/Project/leave.csv"
    return send_file(path, as_attachment=True)

@app.route('/Download_file_stay', methods=['GET', 'POST'])
def Download_file_stay():
    path = "C:/Users/Sony Priya/Desktop/Project/stay.csv"
    return send_file(path, as_attachment=True)
